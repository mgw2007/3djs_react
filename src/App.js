...
class App extends Component {
    constructor(props) {
        ...
        this.state = {screenWidth: 800, screenHeight: 500, hover: "none", brushExtent: [0, 40]}
            ...
            <div className="App">
                ...
                <div>
                    ...
                    <BarChart hoverElement={this.state.hover} onHover={this.onHover} colorScale={colorScale}
                              data={filteredAppdata} size={[this.state.screenWidth / 4, this.state.screenHeight / 2]}/>
                    ...
                    <StreamGraph hoverElement={this.state.hover} onHover={this.onHover} colorScale={colorScale}
                                 data={filteredAppdata} size={[this.state.screenWidth, this.state.screenHeight / 2]}/>
